...
python fmax_evaluation.py --ontology 'BP' --model 'DeepFri' --replace_gobert --best_threshold 0.07 --best_gobert_threshold 0.99 --best_gobert_ratio 0.1
python fmax_evaluation.py --ontology 'CC' --model 'DeepFri' --replace_gobert --best_threshold 0.05 --best_gobert_threshold 0.97 --best_gobert_ratio 0.1
python fmax_evaluation.py --ontology 'MF' --model 'DeepFri' --replace_gobert --best_threshold 0.09 --best_gobert_threshold 0.08 --best_gobert_ratio 0.01

python fmax_evaluation.py --ontology 'BP' --model 'PFresGO' --replace_gobert --best_threshold 0.09 --best_gobert_threshold 0.1 --best_gobert_ratio 0.01
python fmax_evaluation.py --ontology 'CC' --model 'PFresGO' --replace_gobert --best_threshold 0.04 --best_gobert_threshold 0.82 --best_gobert_ratio 0.1
python fmax_evaluation.py --ontology 'MF' --model 'PFresGO' --replace_gobert --best_threshold 0.16 --best_gobert_threshold 0.11 --best_gobert_ratio 0.01

python fmax_evaluation.py --ontology 'BP' --model 'HEAL' --replace_gobert --best_threshold 0.05 --best_gobert_threshold 0.99 --best_gobert_ratio 0.1 
...
python fmax_evaluation.py --ontology 'MF' --model 'HEAL' --replace_gobert --best_threshold 0.07 --best_gobert_threshold 0.11 --best_gobert_ratio 0.01 
